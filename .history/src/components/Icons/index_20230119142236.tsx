...
const SearchIcon: React.FC<IconProps> = ({size = 40, color = 'black'}) => {
  return (
...
const ListIcon: React.FC<IconProps> = ({size = 40, color = 'black'}) => {
  return (
    <Svg width={size} height={size} fill={color} viewBox="0 0 512 512">
...
const FavoriteIcon: React.FC<IconProps> = ({size = 40, color = 'black'}) => {
  return (
    <Svg width={size} height={size} fill={color} viewBox="0 0 512 512">
...
//************************Type ***********************************
const Bug: React.FC<IconProps> = ({size = 40, color = '#fff'}) => {
  return (
...
const Grass: React.FC<IconProps> = ({size = 40, color = '#fff'}) => {
  return (
    <Svg fill="none" height={size} viewBox="0 0 512 512" width={size}>
      <Path
        clip-rule="evenodd"
...
const Dark: React.FC<IconProps> = ({size = 40, color = '#fff'}) => {
  return (
    <Svg
      width={size}
      height={size}
